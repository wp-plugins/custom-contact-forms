...
if (!class_exists('CustomContactFormsActivateDB')) {
	class CustomContactFormsActivateDB extends CustomContactFormsDB {
		...
		function insertFixedFields() {
			...
			$fixedWebsite = array('field_slug' => 'fixedWebsite', 'field_label' => __('Your Website', 'custom-contact-forms'), 'field_type' => 'Text', 'field_value' => '', 'field_maxlength' => '200', 'user_field' => 0, 'field_instructions' => 'Please enter your website.');
			$emailSubject = array('field_slug' => 'emailSubject', 'field_label' => __('Email Subject', 'custom-contact-forms'), 'field_type' => 'Text', 'field_value' => '', 'field_maxlength' => '200', 'user_field' => 0, 'field_instructions' => 'Please enter a subject for the email.');
